...
describe "/contact_lists/index" do
  before(:each) do
    ...
    @contact_lists << Factory(:contact_list_with_uploaded_file)
    #view.stub(:current_user).and_return(Factory(:agent, :admin => true))
    #render
  end
  ...
  describe "as an agent" do
    ...
    it "should not include a link to add a new contact_list" do
      rendered.should_not have_selector("a[href='#{new_contact_list_path}']") 
    end
